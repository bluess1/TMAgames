...
class MultiplayerManager {
    ...
    init() {
        console.log('🌐 Multiplayer Manager ready');
    ...
    simulateConnection() {
        setTimeout(() => {
            ...
            console.log('🤖 Added', this.players.size, 'bot players');
    ...
    handlePlayerJump(playerId, timestamp) {
        ...
        if (player && player.alive && player.isGrounded) {
            player.velocityY = this.game.physics.jumpPower;
            ...
            this.players.forEach(player => {
                if (player.isBot && player.alive) {
                    ...
                    if (!player.isGrounded) {
                        player.velocityY += this.game.physics.gravity;
                    }
...
if (typeof window !== 'undefined') {
    ...
    console.log('✅ MultiplayerManager loaded and available globally');
